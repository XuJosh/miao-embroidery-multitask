"""
加载并推理 combined_fused 网络（含原网络与剪枝网络）。
"""
...
# 与训练 combined_fused_correct 时完全一致的超参
MODEL_KWARGS = {
    'num_patterns': 5,
    'defect_mode': 'cls',
...
def load_checkpoint(model, checkpoint_path, device='cpu'):
    ...
    if checkpoint_path.suffixes[-1:] == ['.gz'] or str(checkpoint_path).endswith('.pth.gz'):
