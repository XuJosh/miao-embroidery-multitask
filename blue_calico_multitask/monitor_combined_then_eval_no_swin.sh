...
# then run evaluations for ResNet50 and combined no ArcFace (Swin excluded).
...
echo "[$(date)] Running evaluations (ResNet50 + combined no ArcFace)..."
...
echo "[$(date)] All evaluations finished."
...
print("\n=== Scheme A corrected-test summary (Swin-Tiny excluded) ===")
